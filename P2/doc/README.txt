...
para el lenguaje de programación "alike". Si existe algún error léxico o sintáctico muestra 
en qué punto de la entrada se ha encontrado con dicho error, y muestra tanto el token erróneo,
